...
class PPOL:
    ...
    def __init__(self,
        ...
        if not self.debug:
            ...
            wandb.init(project="SafeRL-DexterousHand", name=self.log_dir.split('/')[-3] + " " + self.log_dir.split('/')[-2] + " " + currtime+ " cost_lim 25", entity="yiran-geng")
            config = wandb.config
        ...
        if self.is_testing:
            ...
            for it in range(self.current_learning_iteration, num_learning_iterations):
                ...
                if len(ep_cost) == 0:
                    ...
                    print("penalty_item2:", self.penalty_item2)
                if self.print_log:
