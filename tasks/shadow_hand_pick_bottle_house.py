...
import copy
class ShadowHandPickBottleHouse(BaseTask):
    ...
    def _create_envs(self, num_envs, spacing, num_per_row):
        ...
        ground_asset = self.gym.create_box(self.sim, 2.0, 3.0, 0.02, house_asset_options)
        ...
        fixed_object_asset_options.density = 500
