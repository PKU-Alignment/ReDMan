...
import copy
class ShadowHandDrawBlocks(BaseTask):
    ...
    def _create_envs(self, num_envs, spacing, num_per_row):
        ...
        moving_object_asset_options.density = 1
        fixed_object_asset_options = gymapi.AssetOptions()
        fixed_object_asset_options.density = 1
        fixed_object_asset_options.fix_base_link = True
        block_asset = self.gym.create_box(self.sim, 0.26, 0.04, 0.04, asset_options)

        # set object dof properties
        self.num_object_dofs = self.gym.get_asset_dof_count(block_asset)
        object_dof_props = self.gym.get_asset_dof_properties(block_asset)
        ...
        for i in range(self.gym.get_asset_dof_count(block_asset)):
        ...
        object_start_pose1_1.p = gymapi.Vec3(0, 0.07, 0.02)
        object_start_pose1_1.r = gymapi.Quat(0,0,0,1)
        
        object_start_pose1_2 = gymapi.Transform()
        object_start_pose1_2.p = gymapi.Vec3(0, -0.07, 0.02)
        object_start_pose1_2.r = gymapi.Quat(0,0,0,1)
        
        object_start_pose1_3 = gymapi.Transform()
        object_start_pose1_3.p = gymapi.Vec3(-0.07, 0, 0.02)
        object_start_pose1_3.r = gymapi.Quat(0,0,1,1)
        
        object_start_pose1_4 = gymapi.Transform()
        object_start_pose1_4.p = gymapi.Vec3(0.07, 0, 0.02)
        object_start_pose1_4.r = gymapi.Quat(0,0,1,1)
        ...
        max_agg_bodies = self.num_shadow_hand_bodies * 2 + 4 * self.num_object_bodies + self.num_table_bodies
        max_agg_shapes = self.num_shadow_hand_shapes * 2 + 4 * self.num_object_shapes + self.num_table_shapes
        ...
        for i in range(self.num_envs):
            ...
            block_handle1 = self.gym.create_actor(env_ptr, block_asset, object_start_pose1_1, "object", i+10000000, 0, 0)
            block_handle2 = self.gym.create_actor(env_ptr, block_asset, object_start_pose1_2, "object", i, 0, 0)
            block_handle3 = self.gym.create_actor(env_ptr, block_asset, object_start_pose1_3, "object", i+10000000, 0, 0)
            block_handle4 = self.gym.create_actor(env_ptr, block_asset, object_start_pose1_4, "object", i, 0, 0)
            # object_handle5 = self.gym.create_actor(env_ptr, fixed_object_asset, object_start_pose5, "object", i+10000000, 0, 0)
            
            self.object1_init_state.append([object_start_pose1_1.p.x, object_start_pose1_1.p.y, object_start_pose1_1.p.z,
                                           object_start_pose1_1.r.x, object_start_pose1_1.r.y, object_start_pose1_1.r.z, object_start_pose1_1.r.w,
                                           0, 0, 0, 0, 0, 0])
            self.object2_init_state.append([object_start_pose1_2.p.x, object_start_pose1_2.p.y, object_start_pose1_2.p.z,
                                           object_start_pose1_2.r.x, object_start_pose1_2.r.y, object_start_pose1_2.r.z, object_start_pose1_2.r.w,
                                           0, 0, 0, 0, 0, 0])
            self.object3_init_state.append([object_start_pose1_3.p.x, object_start_pose1_3.p.y, object_start_pose1_3.p.z,
                                           object_start_pose1_3.r.x, object_start_pose1_3.r.y, object_start_pose1_3.r.z, object_start_pose1_3.r.w,
                                           0, 0, 0, 0, 0, 0])
            self.object4_init_state.append([object_start_pose1_4.p.x, object_start_pose1_4.p.y, object_start_pose1_4.p.z,
            ...
            self.gym.set_actor_dof_properties(env_ptr, block_handle1, object_dof_props)
            self.gym.set_actor_dof_properties(env_ptr, block_handle2, object_dof_props)
            self.gym.set_actor_dof_properties(env_ptr, block_handle3, object_dof_props)
            self.gym.set_actor_dof_properties(env_ptr, block_handle4, object_dof_props)
            # self.gym.set_actor_dof_properties(env_ptr, object_handle5, object_dof_props)
            object1_idx = self.gym.get_actor_index(env_ptr, block_handle1, gymapi.DOMAIN_SIM)
            object2_idx = self.gym.get_actor_index(env_ptr, block_handle2, gymapi.DOMAIN_SIM)
            object3_idx = self.gym.get_actor_index(env_ptr, block_handle3, gymapi.DOMAIN_SIM)
            object4_idx = self.gym.get_actor_index(env_ptr, block_handle4, gymapi.DOMAIN_SIM)
            ...
            object_dof_props = self.gym.get_actor_dof_properties(env_ptr, block_handle1)
            ...
            #set friction
            object1_shape_props = self.gym.get_actor_rigid_shape_properties(env_ptr, block_handle1)
            for object1_shape_prop in object1_shape_props:
                object1_shape_prop.friction = 0.1
            object2_shape_props = self.gym.get_actor_rigid_shape_properties(env_ptr, block_handle2)
            for object2_shape_prop in object2_shape_props:
                object2_shape_prop.friction = 100
            object3_shape_props = self.gym.get_actor_rigid_shape_properties(env_ptr, block_handle3)
            for object3_shape_prop in object3_shape_props:
                object3_shape_prop.friction = 0.1
            object4_shape_props = self.gym.get_actor_rigid_shape_properties(env_ptr, block_handle4)
            ...
            self.gym.set_actor_rigid_shape_properties(env_ptr, block_handle1, object1_shape_props)
            self.gym.set_actor_rigid_shape_properties(env_ptr, block_handle2, object2_shape_props)
            self.gym.set_actor_rigid_shape_properties(env_ptr, block_handle3, object3_shape_props)
            self.gym.set_actor_rigid_shape_properties(env_ptr, block_handle4, object4_shape_props)
    ...
    def compute_reward(self, actions):
        self.rew_buf[:], self.reset_buf[:], self.progress_buf[:], self.successes[:], self.consecutive_successes[:] = compute_hand_reward(
            ...
            self.object1_pos, self.object1_rot,  
            self.object2_pos, self.object2_rot, 
            self.object3_pos, self.object3_rot, 
            self.object4_pos, self.object4_rot, 
...
def compute_hand_reward(
    ...
    object1_pos, object1_rot,
    object2_pos, object2_rot,
    object3_pos, object3_rot, 
    object4_pos, object4_rot,
    # object5_pos, object5_rot, 
