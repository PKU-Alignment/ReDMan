...
class ShadowHandOverWallDownHouse(BaseTask):
    ...
    def _create_envs(self, num_envs, spacing, num_per_row):
        ...
        max_agg_bodies = self.num_shadow_hand_bodies * 2 + 3 + 5
        max_agg_shapes = self.num_shadow_hand_shapes * 2 + 3 + 5
        ...
        for i in range(self.num_envs):
            ...
            self.gym.set_rigid_body_color(env_ptr, wall_handle, 0, gymapi.MESH_VISUAL_AND_COLLISION,
