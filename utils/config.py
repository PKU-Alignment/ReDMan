...
def retrieve_cfg(args, use_rlg_config=False):
    ...
    if args.task == "ShadowHandOver":
    ...
    elif args.task == "ShadowHandDieRotation":
        return os.path.join(args.logdir, "shadow_hand_die_rotation/{}/{}".format(args.algo, args.algo)), "cfg/{}/config.yaml".format(args.algo) , "cfg/shadow_hand_die_rotation.yaml"
    elif args.task == "ShadowHandGrasp":
    ...
    elif args.task == "ShadowHandOverWall":
        return os.path.join(args.logdir, "shadow_hand_over_wall/{}/{}".format(args.algo, args.algo)), "cfg/{}/config.yaml".format(args.algo) , "cfg/shadow_hand_over_wall.yaml"
    elif args.task == "ShadowHandOverWallHouse":
        return os.path.join(args.logdir, "shadow_hand_over_wall_house/{}/{}".format(args.algo, args.algo)), "cfg/{}/config.yaml".format(args.algo) , "cfg/shadow_hand_over_wall.yaml"
    elif args.task == "ShadowHandOverWallPC":
        return os.path.join(args.logdir, "shadow_hand_over_wall_pc/{}/{}".format(args.algo, args.algo)), "cfg/{}/config.yaml".format(args.algo) , "cfg/shadow_hand_over_wall.yaml"
    elif args.task == "ShadowHandOverWallPCNew":
        return os.path.join(args.logdir, "shadow_hand_over_wall_pc_new/{}/{}".format(args.algo, args.algo)), "cfg/{}/config.yaml".format(args.algo) , "cfg/shadow_hand_over_wall_pc.yaml"
    elif args.task == "ShadowHandOverWallDown":
        return os.path.join(args.logdir, "shadow_hand_over_wall_down/{}/{}".format(args.algo, args.algo)), "cfg/{}/config.yaml".format(args.algo) , "cfg/shadow_hand_over_wall_down.yaml"
    elif args.task == "ShadowHandOverWallDownHouse":
        return os.path.join(args.logdir, "shadow_hand_over_wall_down_house/{}/{}".format(args.algo, args.algo)), "cfg/{}/config.yaml".format(args.algo) , "cfg/shadow_hand_over_wall_down.yaml"
    elif args.task == "ShadowHandPickBottle":
        return os.path.join(args.logdir, "shadow_hand_pick_bottle/{}/{}".format(args.algo, args.algo)), "cfg/{}/config.yaml".format(args.algo) , "cfg/shadow_hand_pick_bottle.yaml"
    elif args.task == "ShadowHandPickBottleHouse":
        return os.path.join(args.logdir, "shadow_hand_pick_bottle_house/{}/{}".format(args.algo, args.algo)), "cfg/{}/config.yaml".format(args.algo) , "cfg/shadow_hand_pick_bottle.yaml"
    elif args.task == "ShadowHandJenga":
        return os.path.join(args.logdir, "shadow_hand_jenga/{}/{}".format(args.algo, args.algo)), "cfg/{}/config.yaml".format(args.algo) , "cfg/shadow_hand_jenga.yaml"
    ...
    elif args.task == "ShadowHandCatchOver2Underarm_Safe_finger_house":
        return os.path.join(args.logdir, "ShadowHandCatchOver2underarm_Safe_finger_house/{}/{}".format(args.algo, args.algo)), "cfg/{}/config.yaml".format(args.algo), "cfg/ShadowHandCatchOver2underarm_Safe_finger.yaml"
        ...
        return os.path.join(args.logdir, "shadow_hand_catch_underarm_wall/{}/{}".format(args.algo, args.algo)), "cfg/{}/config.yaml".format(args.algo), "cfg/shadow_hand_catch_underarm_wall.yaml"    
    elif args.task == "ShadowHandCatchUnderarmWallDown":
        return os.path.join(args.logdir, "shadow_hand_catch_underarm_wall_down/{}/{}".format(args.algo, args.algo)), "cfg/{}/config.yaml".format(args.algo), "cfg/shadow_hand_catch_underarm_wall_down.yaml"   
    elif args.task == "ShadowHandAllegroHandJenga":
        return os.path.join(args.logdir, "shadow_hand_and_allegro_hand_jenga/{}/{}".format(args.algo, args.algo)), "cfg/{}/config.yaml".format(args.algo), "cfg/shadow_hand_allegro_hand_jenga.yaml"   
    elif args.task == "ShadowHandAllegroHandArmJenga":
        return os.path.join(args.logdir, "shadow_hand_and_allegro_hand_arm_jenga/{}/{}".format(args.algo, args.algo)), "cfg/{}/config.yaml".format(args.algo), "cfg/shadow_hand_allegro_hand_jenga.yaml"   
    elif args.task == "ShadowHandAllegroHandJengaHouse":
        return os.path.join(args.logdir, "shadow_hand_and_allegro_hand_jenga_house/{}/{}".format(args.algo, args.algo)), "cfg/{}/config.yaml".format(args.algo), "cfg/shadow_hand_allegro_hand_jenga.yaml"   
    elif args.task == "ShadowHandAllegroHandJengaHousePC":
        return os.path.join(args.logdir, "shadow_hand_and_allegro_hand_jenga_house_pc/{}/{}".format(args.algo, args.algo)), "cfg/{}/config.yaml".format(args.algo), "cfg/shadow_hand_allegro_hand_jenga.yaml"   
    elif args.task == "ShadowHandClean":
        return os.path.join(args.logdir, "shadow_hand_clean/{}/{}".format(args.algo, args.algo)), "cfg/{}/config.yaml".format(args.algo), "cfg/ShadowHandClean.yaml"   
    elif args.task == "ShadowHandCleanHouse":
        return os.path.join(args.logdir, "shadow_hand_clean_house/{}/{}".format(args.algo, args.algo)), "cfg/{}/config.yaml".format(args.algo), "cfg/ShadowHandClean.yaml" 
    elif args.task == "AllegroHandCatchUnderarm":
        return os.path.join(args.logdir, "allegro_hand_catch_underarm/{}/{}".format(args.algo, args.algo)), "cfg/{}/config.yaml".format(args.algo), "cfg/AllegroHandCatchUnderarm.yaml"    
...
def get_args(benchmark=False, use_rlg_config=False):
    ...
    if args.algo not in ["maddpg", "happo", "mappo", "hatrpo","ippo","ppo","sac","td3","ddpg","trpo","ppol","focops","p3o", "pcpo", "cpo", "trpol", "cppo_pid"]:
        warn_algorithm_name()
